...
var objImagePreloader=new Image();objImagePreloader.onload=function(){$('#lightbox-image').attr('src',settings.imageArray[settings.activeImage][0]);_resize_container_image_box(objImagePreloader.width,objImagePreloader.height);objImagePreloader.onload=function(){};};objImagePreloader.src=settings.imageArray[settings.activeImage][0];};function _resize_container_image_box(intImageWidth,intImageHeight){var intCurrentWidth=$('#lightbox-container-image-box').width();var intCurrentHeight=$('#lightbox-container-image-box').height();var intWidth=(intImageWidth+(settings.containerBorderSize*2));var intHeight=(intImageHeight+(settings.containerBorderSize*2));var intDiffW=intCurrentWidth-intWidth;var intDiffH=intCurrentHeight-intHeight;
var winWidth = window.innerWidth;
//added WS
if (intWidth>winWidth) {var newWidth = winWidth - 30; intHeight = parseInt(intHeight / (intWidth/newWidth)); intWidth = newWidth; intImageWidth = newWidth-(settings.containerBorderSize*2); 
intImageHeight = intHeight-(settings.containerBorderSize*2); document.getElementById('lightbox-image').style.width = intImageWidth+"px";}
